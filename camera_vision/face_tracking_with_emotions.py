"""
Face Tracking with Emotions - Interactive Robot Behavior

This demo combines face detection with emoji robot emotions, creating
an interactive and expressive robot that responds to people.

Behaviors:
- Shows CURIOUS emotion when first detecting a face
- Shows HAPPY emotion when person stays in view
- Shows SAD emotion when person leaves (face disappears)
- Tracks face with head movements continuously

Perfect for: Interactive demonstrations, testing emotion responses
"""
...
BANNER = """
==================================================
REACHY MINI - FACE TRACKING WITH EMOTIONS
==================================================
"""
...
class EmotionStateMachine:
    ...
    def execute_emotion(self):
        """Execute the current emotion if needed."""
...
def init_robot():
    ...
    print(BANNER)
    print("⚠️  Make sure simulator is running!")
